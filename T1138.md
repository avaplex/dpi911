...
## Detection:
* use of Shim software such as Shim-Process-Scanner, Shim-Detector-Lite, etc
* [Read Mitre ATT&CK for more Detection info](https://attack.mitre.org/wiki/Technique/T1138)
